...
fun HomeScreen(
    ...
    LazyColumn {
        ...
        item {
            Spacer(modifier = Modifier.height(16.dp))
            val pillowProducts = products.filter { it.category_id == 5 } // 1 = Pillow category id
            ProductGridSection(
        ...
        item {
            Spacer(modifier = Modifier.height(16.dp))
            val bolsterProducts = products.filter { it.category_id == 1 } // 2 = Bolster Pillow category id
            ProductGridSection(
